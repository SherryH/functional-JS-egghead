...
// examples: Array: [1,2].concat([3]) => [1,2,3]
// String: 'a'.concat('b') => 'ab'

// Sum: Sum(1).concat(Sum(3)) => Sum(4)
...
console.log("Sum(22).concat(Sum(33)): ", Sum(22).concat(Sum(33)));
...
console.log("All(true).concat(All(false)): ", All(true).concat(All(false)));

console.log("All(true).concat(All(true)): ", All(true).concat(All(true)));
...
// testing
console.log(`acct1.concat(acct2) : `, res.toJS());
